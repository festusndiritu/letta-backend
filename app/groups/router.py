...
def _serialize(conv, meta: dict | None = None) -> ConversationOut:
    meta = meta or {}
...
async def list_conversations(
    ...
    return [_serialize(conv, meta) for conv, meta in convs]
...
async def create_direct(
    ...
    meta = await service.get_conversation_meta(conv.id, current_user.id, db)
    return _serialize(conv, meta)
